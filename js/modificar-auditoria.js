...
$btnMejoras.addEventListener("click", () => {
  agregaraTabla("mejoras", "tabla-mejoras", "mejora");
});

$btnComentarios.addEventListener("click", () => {
  agregaraTabla("comentarios", "tabla-comentarios", "comentario");
});
...
$btnConclusiones.addEventListener("click", () => {
  agregaraTabla("conclusion", "tabla-conclusiones", "conclusion");
});

function agregaraTabla(idInput, idTable, tipo = "") {
  const input = document.getElementById(idInput);
  const valor = input.value.trim();
  ...
  // Agregar atributos extra según el tipo
  switch (tipo) {
    case "comentario":
      infoObjeto.idComentario = "";
      break;
    case "conclusion":
      infoObjeto.idConclusion = "";
      break;
    case "noConformidad":
      infoObjeto.idNoConformidad = "";
      break;
    case "mejora":
      infoObjeto.idMejora = "";
      break;
