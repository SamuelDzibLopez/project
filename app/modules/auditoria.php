                ...
                <div class="div-main-white">
                    <div class="div-main-ITM">
                        <div class="div-title">
                            ...
                            <h2 class="font-title">Auditoria</h2>
                        </div>

                        <!-- Auditoria -->
                        <div class="div-gray" id="auditoria">
                            <form class="div-main-blur" id="form-auditoria-modificar">
                                ...
                                <div class="div_buttons">
                                    <button type="submit" class="btn-apartado-center escalado">Modificar auditoria</button>
                                </div>
                            </form>
                        </div>
