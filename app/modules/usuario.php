                    ...
                    <div class="div-main-ITM">
                        <form class="div-main-blur" id="form_datos">
                            <div class="div-title">
                                ...
                                <h2 class="font-title">Información de usuario</h2>
                            </div>
                            ...
                            <div class="div-gray">
                                <div class="div-subtitle">
                                    ...
                                    <h2 class="font-subtitle">Vigencia de usuario</h2>
                                </div>
                                <hr class="hr-blue">
                                <div class="div-mis-datos">
                                    <div class="div-datos-mis-datos">
                                        <div class="input-mis-datos">
                                            ...
                                            <input name="fecha_vigencia" type="date" class="input-mis-datos none">
                                        </div>
                                        <div class="input-mis-datos">
                                        ...
                                        <div class="div_buttons">
                                            ...
                                            <button type="button" class="btn-apartado-center btn_green escalado" id="btn-validar">Validar/Invalidar usuario</button>
                                            <button type="button" class="btn-apartado-center btn_red escalado" id="btn-eliminar">Eliminar usuario</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
