...
<body>
                ...
                <div class="div-main-white">
                    ...
                    <form class="div-main-blur" id="form_datos" enctype="multipart/form-data">
                            <div class="div-title">
                                ...
                                <h2 class="font-title">Nuevo usuario</h2>
                            </div>
                            ...
                            <div class="div-gray">
                                <div class="div-subtitle">
                                    <img src="/project/sources/icons/icon-usuarios.svg" alt="">
                                    <h2 class="font-subtitle">Datos</h2>
                                </div>
                                <hr class="hr-blue">
                                <div class="div-mis-datos">
                                    ...
                                    <div class="div-datos-mis-datos">
                                        <input type="text" placeholder="USUARIO" class="input-mis-datos" name="usuario">
                                        <input type="password" placeholder="CONTRASEÑA" class="input-mis-datos" name="contraseña">
                                        <input type="password" placeholder="CONFIRMAR CONTRASEÑA" class="input-mis-datos" name="confirmar_contraseña">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="div-gray">
                                ...
                                <div class="div-mis-datos">
                                    <div class="div-datos-mis-datos">
                                        ...
                                        <select name="rol" class="input-mis-datos">
                                ...
                                <div class="div-mis-datos">
                                    <div class="div-datos-mis-datos">
                                        <div class="input-mis-datos">
                                            ...
                                            <input name="fecha_vigencia" type="date" class="input-mis-datos none" id="date-two">
                                        </div>
                                        <div class="input-mis-datos">
                                            <label for="doc_vigencia">ARCHIVO DE VIGENCIA</label>
                                            <a class="href_document" href="#" target="-blank" id="text_vigencia"></a>
                                            <input type="file" class="input-mis-datos none" id="doc_vigencia" accept=".pdf" name="vigencia" hidden>
                                        </div>
                                        <div class="input-mis-datos">
                                            ...
                                            <input type="file" class="input-mis-datos none" id="efirma" accept="image/*" name="firma" hidden>
                                            </div>
                                        <button type="submit" class="btn-apartado-center escalado">Crear usuario</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script type="module" src="./../../js/nuevo-usuario.js"></script>
</body>
</html>