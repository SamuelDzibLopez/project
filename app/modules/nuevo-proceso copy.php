                    ...
                    <div class="div-main-ITM">
                            ...
                            <div class="div-mis-datos">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="opciones">
                                        ...
                                        <option value="4">Acción correctiva</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="div-gray" id="pnc">
                            <form class="div-main-blur" id="pnc-form">
                                ...
                                <!--botones-->
                                <div class="div_buttons">
                                    <button type="submit" class="btn-apartado-center escalado">Crear Productos No
                                        Conformes</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="div-gray" id="accionCorrectiva">
                            <form class="div-main-blur" id="ac-form">
                                ...
                                <div class="div-datos-mis-datos inputs-responsive">
                                    ...
                                    <!--Fecha de registro-->
                                    <div class="mb-3 inputs-responsive">
                                        <label for="ac-fecha-registro-accion" class="form-label inputs-responsive">Fecha de registro</label>
                                ...
                                <!--botones-->
                                <div class="div_buttons">
                                    <button type="submit" class="btn-apartado-center escalado">Crear Acción correctiva</button>
                                </div>
                            </form>
                        </div>
                    </div>
