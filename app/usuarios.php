                    ...
                    <div class="div-main-ITM">
                        <div class="div-main-blur">
                            <div class="div-title">
                                ...
                                <h2 class="font-title">Usuarios</h2>
                            </div>
                            ...
                            <div class="div-gray">
                                <div class="div-subtitle">
                                    <img src="./../sources/icons/icon-usuarios.svg" alt="">
                                    <h2 class="font-subtitle">Nuevo usuario</h2>
                                </div>
                                <hr class="hr-blue">
                                <div class="div-mi-perfil">
                                    <div class="div-perfil">
                                    </div>
                                        <button class="btn-apartado-center escalado" id="btn-nuevo-usuario">Nuevo usuario</button>
                            ...
                            <div class="div-gray">
                                <div class="div-subtitle">
                                    <img src="./../sources/icons/icon-usuarios.svg" alt="">
                                    <h2 class="font-subtitle">Usuarios existentes</h2>
                                </div>
                                <hr class="hr-blue">
                                ...
                                <div class="div-usuarios">
                                    ...
                                    <button class="btn-apartado-center escalado" id="btn_users">Ver más usuarios</button>
                                </div>
                            </div>
                        </div>
                    </div>
